...
use crate::common::jdbc_index_search_result::{JDBCIndexSearchResult, JDBCSearchResult};
...
pub async fn get_jdbc_index_missing_field_but_has<T: ToString>(
    index_name: T,
    missing_field: T,
    has_field: T,
    elastic_url: T,
...
fn get_jdbc_transform_config() -> Vec<Transform> {
